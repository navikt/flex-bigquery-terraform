...
SELECT
  ...
  svar.verdi
FROM
  `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_sykepengesoknad` sykepengesoknad
INNER JOIN
  `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_sporsmal` sporsmal
ON
  sporsmal.sykepengesoknad_id = sykepengesoknad.id
INNER JOIN
  `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_svar` svar
ON
...
FROM `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_klipp_metrikk`
EOF
...
WITH ja_hovedspm AS (SELECT sporsmal.id
                     FROM `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_sporsmal` sporsmal
                              INNER JOIN
                          `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_svar` svar
                          ON
                              svar.sporsmal_id = sporsmal.id
     ...
     checkboxmedsvar AS (SELECT checkboxider.*, svar.verdi
                         FROM checkboxider
                                  LEFT OUTER JOIN `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_svar` svar
...
FROM checkboxmedsvar
         INNER JOIN `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_sykepengesoknad` soknad
...
FROM `${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_sykepengesoknad` ss,
`${var.gcp_project["project"]}.${module.sykepengesoknad_datastream.dataset_id}.public_yrkesskade_sykmelding` ys
WHERE ss.sykmelding_uuid = ys.sykmelding_id
EOF

}

// Brukes i Soda-sjekk i Team HAG for å hente ut søknadsperioder for sykepengesøknader.
